...
| Production viewer | `LIVE` | Bundled Spark 2.1, private range delivery, adaptive budgets, progress/error/retry telemetry, guided rooms, live floor plan, v7 reviewed structural collision, verified multi-level Recast navigation, Rapier Walk/Fly movement, and public multi-room production scene | Broader measured physical phone matrix plus authored elevator/ladder traversal |
