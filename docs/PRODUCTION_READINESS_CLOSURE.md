...
| Format pipeline | `LIVE` | Evidence validation, generated Spark RAD plus an optional compact SPZ `portable` derivative for Gaussian PLY sources, SPZ/SOG delivery of operator-uploaded browser-ready assets (SOG is never generated), malformed-input tests, posters, reports, purpose/format separation, and vendor-neutral metric PLY/E57/LAS/LAZ/PTS normalisation through pinned PDAL | Licensed K1/P2 export and quality comparison |
