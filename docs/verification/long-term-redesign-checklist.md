...
- 56 migrations declared and consistent;
- 83 navigation tests passed;
- 56 Worker test files and 334 tests passed;
- coverage: 71.36% statements, 60.91% branches, 85.30% functions, and 77.90%
  lines;
